...
Contributor: [Chiru deep reddy / Contributor]

The Daily Expense Tracker System is a web-based application designed to help users manage their daily expenses efficiently. This tool simplifies tracking and calculating daily expenditures, reducing manual effort and providing a clear overview of spending habits. Each user's expense data is securely stored, ensuring personalized tracking and management.

Note 🔴: This code has been adapted from an existing project source available on the web, with modifications to enhance functionality and user experience.
...
🟦 Features :
 ...
 3) user Dashboard
 4) Add-Expenses
 5) A family can join and one person can make a family and they get a secure code . The other family members can only join if and only if the secure code is entered .
 6) Chat function if you join a family you can chat with your family members and send photos also alax is used to continiously reload the page .
 7) Manage Expenses
 8) Add-Lending
 9) Manage Lending
